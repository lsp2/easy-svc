...
class Svc(object):
    ...
    def infer(self, speaker, tran, raw_path,
        ...
        return audio, audio.shape[-1], n_frames, use_time
    ...
    def slice_inference(self,
        ...
        audio_data, audio_sr, audio_len = slicer.chunks2audio(wav_path, chunks)
        ...
        for (slice_tag, data) in audio_data:
            ...
            if slice_tag:
                ...
                finished_len += len(data)
                progress = round(finished_len / audio_len * 100, 1)
            ...
            for k,dat in enumerate(datas):
                ...
                raw_path.seek(0)
                out_audio, out_sr, out_frame, use_time = self.infer(spk, tran, raw_path,
